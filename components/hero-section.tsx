        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            >
              ...
              />
              JURA REPARATIE SPECIALIST &middot; ZEELAND
            </motion.div>
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                Onafhankelijke reparatie van Jura koffie- en espressomachines. Meer dan 20 jaar ervaring uit Goes.
              </motion.p>
            </div>
            ...
            >
              {["20+ jaar ervaring", "Onafhankelijk", "Snel & betrouwbaar", "Heel Zeeland"].map((benefit, i) => (
                <motion.div
                  key={benefit}
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              ...
              >
                <Image
                  src="/images/jura-hero.png"
                  alt="Jura automatische espressomachine"
                  width={420}
                  height={420}
