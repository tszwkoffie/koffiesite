...
import { Clock, ShieldCheck, MapPin, Wrench } from "lucide-react"

const features = [
  {
    icon: Clock,
    title: "20+",
    subtitle: "Jaar ervaring",
    description: "Doorgewinterde kennis van Jura",
    accent: "#AFFF00",
  },
  {
    icon: ShieldCheck,
    title: "100%",
    subtitle: "Onafhankelijk",
    description: "Eerlijk advies, geen verplichtingen",
    accent: "#AFFF00",
  },
  {
    icon: MapPin,
    title: "Zeeland",
    subtitle: "Regio Goes",
    description: "Lokaal en snel ter plaatse",
    accent: "#00D4FF",
  },
  {
    icon: Wrench,
    title: "Jura",
    subtitle: "Specialist",
    description: "Volledig gericht op uw merk",
    accent: "#AFFF00",
  },
]
...
export function BentoGrid() {
  ...
  return (
    <section id="over-ons" className="relative py-16 bg-[#121212] overflow-hidden">
