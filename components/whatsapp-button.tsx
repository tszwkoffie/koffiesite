...
export function WhatsAppButton() {
  const phone = "31623212870"
  const message = "Hallo, ik heb een vraag over de reparatie van mijn Jura machine."
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 bg-[#25D366] text-white pl-3 pr-4 py-3 rounded-full shadow-lg shadow-black/20 font-bold text-sm"
    ...
    >
      ...
      <svg className="w-6 h-6 relative z-10" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
